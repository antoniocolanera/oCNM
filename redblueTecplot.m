...
% pos=linspace(0,1,7);
%Colormap key colors from Tecplot FRANCE

rT=[33 103 255 255 255 239 178]/255;
gT=[102 169 255 255 255 138 24]/255;
bT=[172 207 255 255 255 98 43]/255;
pos=[0 0.2 0.4 0.5 0.6 0.8 1];
